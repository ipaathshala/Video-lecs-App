...
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card m-b-20 m-t-20">
                  <div class="card-body">
                    <h4 class="mt-0 header-title">Upload Chapters</h4>
                    <form>
                      <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-lg-12">
                          <div class="form-group">
                            ...
                            <div class="alert alert-danger" role="alert" id="invsubject"><strong>Error! Select Subject</strong></div>
    ...
    <script src="custom-js/save-chapter.js"></script>
  </body>
</html>